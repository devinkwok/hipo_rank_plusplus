...
from hipo_rank.clusterings.unsupervised import UnsupervisedClustering, RandomClusteringAlgorithm
...
CLUSTERINGS = [
    ...
    ('spectral', UnsupervisedClustering, {
...
results_path = Path(f"results/hpp_clustering")
...
for embedder_id, embedder, embedder_args in EMBEDDERS:
    ...
    for dataset_id, dataset, dataset_args in DATASETS:
        ...
        for clustering_id, clustering, clustering_args in CLUSTERINGS:
            ...
            embeds_and_docs = [Clustering.get_clusters(e, d) for e, d in tqdm(zip(embeds, docs))]
            ...
            for similarity_id, similarity, similarity_args in SIMILARITIES:
                ...
                for direction_id, direction, direction_args in DIRECTIONS:
                    ...
                    for scorer_id, scorer, scorer_args in SCORERS:
                        ...
                        experiment = f"{dataset_id}-{embedder_id}-{clustering_id}-{similarity_id}-{direction_id}-{scorer_id}"
